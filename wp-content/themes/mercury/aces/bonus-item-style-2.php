...
?>
<li class="bonus-code row align-items-center">
    <div class="col-md-3 col-sm-3 col-xs-12 no-gutter text-center">
        <div>
    ...
    <div class="col-md-9 col-sm-9 col-xs-12 bg-white position-relative" style="border-top-right-radius:10px;">
