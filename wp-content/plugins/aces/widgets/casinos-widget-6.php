...
/*  Display #6 Casinos Homepage Widget  */
	...
	<div class="space-organizations-home-4-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
