...
/*  #10 Casinos Homepage Widget  */

class aces_casinos_home_10_widget extends WP_Widget {

/*  #10 Casinos Homepage Widget Setup  */

	public function __construct() {
		parent::__construct(false, $name = esc_html__('#Aces Casinos-10', 'aces' ), array(
			'description' => esc_html__('#10 Casinos widget for the HOMEPAGE (Mercury theme).', 'aces' )
		));
	}

/*  Display #10 Casinos Homepage Widget  */
	...
	<div class="space-organizations-home-8-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
...
/*  Update #10 Casinos Homepage Widget  */
...
/*  #10 Casinos Homepage Widget Settings Form  */
...
add_action( 'widgets_init', 'aces_casinos_home_10_widget' );

function aces_casinos_home_10_widget() {
	register_widget( 'aces_casinos_home_10_widget' );
}