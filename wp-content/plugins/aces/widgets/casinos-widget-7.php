...
/*  Display #7 Casinos Homepage Widget  */
	...
	<div class="space-organizations-home-5-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
		<div class="space-organizations-home-5-widget-ins space-page-wrapper relative">
